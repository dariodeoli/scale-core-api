...
for(const file of ['20260910_company_currency.sql','20260910_global_identity.sql','20260916_identity_photo_removal.sql','20260910_project_assignees.sql','20260910_inventory_reservations.sql','20260910_work_checklists.sql'])await pg.exec(await fs.readFile('migrations/'+file,'utf8'));
