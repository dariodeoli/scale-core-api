...
for(const f of ['20260911_subscriptions.sql','20260911_trial_registration.sql','20260912_platform_admin.sql','20260913_platform_admin_vertical_slice.sql'])await db.exec(await fs.readFile(new URL(`./migrations/${f}`,import.meta.url),'utf8'));
