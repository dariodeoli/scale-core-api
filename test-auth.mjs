...
for(const f of ['20260911_subscriptions.sql','20260911_trial_registration.sql','20260914_google_pending_trial_registration.sql','20260912_platform_admin.sql','20260913_platform_admin_vertical_slice.sql'])await db.exec(await fs.readFile(new URL(`./migrations/${f}`,import.meta.url),'utf8'));
for(const f of ['20260910_client_lifecycle.sql','20260911_agency_reports.sql','20260911_invite_link_metrics.sql','20260911_invite_link_details.sql','20260912_account_security.sql','20260914_secure_deletion.sql','20260912_client_portal.sql','20260912_client_portal_google_oauth.sql','20260913_client_portal_vertical_slice.sql'])await db.exec(await fs.readFile(new URL(`./migrations/${f}`,import.meta.url),'utf8'));
