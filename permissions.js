...
export const roles=['owner','admin','management','finance','sales','production','editor','viewer','colaborador'];
export const roleLabels={owner:'Dueño',admin:'Administrador',management:'Gerencia',finance:'Finanzas',sales:'Ventas',production:'Producción',editor:'Editor',viewer:'Solo lectura',colaborador:'Colaborador'};
const all=[...roles];
export const CAPABILITIES=[
 ...
 {id:'clients.manage',label:'Gestionar clientes',description:'Crear y editar clientes, enlaces y ficha comercial.',roles:['owner','admin','management','sales','finance','colaborador']},
 {id:'projects.manage',label:'Crear proyectos',description:'Crear proyectos de trabajo.',roles:['owner','admin','management','sales','production','colaborador']},
 {id:'projects.edit',label:'Editar proyectos',description:'Editar datos y responsables de proyectos.',roles:['owner','admin','management','production','colaborador']},
 {id:'work-orders.manage',label:'Gestionar piezas',description:'Crear piezas y acciones de producción.',roles:['owner','admin','management','production','colaborador']},
 {id:'work-orders.edit',label:'Editar y mover piezas',description:'Editar piezas y cambiar su estado.',roles:['owner','admin','management','production','editor','colaborador']},
 {id:'assignees.manage',label:'Responsables',description:'Asignar responsables a proyectos y piezas.',roles:['owner','admin','management','production','colaborador']},
 {id:'checklists.edit',label:'Checklists',description:'Editar checklists de piezas.',roles:['owner','admin','management','production','editor','colaborador']},
 {id:'commercial.manage',label:'Pipeline comercial',description:'Oportunidades y seguimiento comercial.',roles:['owner','admin','management','finance','sales','colaborador']},
 {id:'budgets.manage',label:'Presupuestos y planes',description:'Presupuestos, planes reutilizables y cotización.',roles:['owner','admin','management','finance','sales','production','colaborador']},
 ...
 {id:'inventory.manage',label:'Gestionar inventario',description:'Equipos, categorías y ubicaciones.',roles:['owner','admin','management','production','finance','colaborador']},
 {id:'inventory.book',label:'Reservar equipos',description:'Crear y editar reservas de equipos.',roles:['owner','admin','management','production','colaborador']},
 {id:'studio.manage',label:'Estudio',description:'Espacios y reservas del estudio.',roles:['owner','admin','management','sales','colaborador']},
 {id:'portal.manage',label:'Portal del cliente',description:'Publicar entregas y gestionar revisiones.',roles:['owner','admin','management','production','colaborador']},
