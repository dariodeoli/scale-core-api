...
export const CAPABILITIES=[
 ...
 {id:'clients.manage',label:'Gestionar clientes',description:'Crear y editar clientes, enlaces y ficha comercial.',roles:['owner','admin','management','sales']},
 ...
 {id:'commercial.manage',label:'Pipeline y presupuestos',description:'Oportunidades, planes, presupuestos y cotización.',roles:['owner','admin','management','finance','sales']},
 ...
 {id:'reports.view',label:'Informes',description:'Informes mensuales y evolución.',roles:['owner','admin','finance']},
 ...
 {id:'studio.manage',label:'Estudio',description:'Espacios y reservas del estudio.',roles:['owner','admin','management']},
